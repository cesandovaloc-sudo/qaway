  ...
  return (
    <>
      ...
      <Routes>
        ...
        />
        <Route
          path="/pruebas/recursos"
          element={renderRoute('pruebas', <RecursosPruebaPage />)}
        />
        <Route
          path="/pruebas/recursos/:category"
          element={renderRoute('pruebas', <RecursosPruebaPage />)}
        />
        ...
        <Route element={<Layout />}>
          ...
          <Route
            path="recursos/visor/:id"
            element={renderRoute('recursos', <RecursoVisorPage />)}
          />
          <Route path="recursos/*" element={renderRoute('recursos', <RecursosPage />)} />
          <Route path="recursos-v2" element={renderRoute('recursos', <RecursosV2Page />)} />
          <Route
            path="recursos-v2/visor"
            element={renderRoute('recursos', <EbookVisorV2Page />)}
          />
