...
const categories = [
  ...
  { icon: BookMarked, title: 'Guías', key: 'guias', description: 'Metodologías estratégicas para guiar la digitalización y reingeniería de tu marca.' },
  ...
  { icon: Terminal, title: 'Scripts', key: 'scripts', description: 'Pasos de configuración técnica para workflows de automatización e integraciones IA.' },
]
...
const resources = [
  ...
  },
  {
    ...
    description: 'Estructura lista para documentar procesos y automatizaciones de tu negocio, facilitando la delegación sin fricciones.',
    type: 'Plantilla Notion',
    badge: 'Premium',
    path: '/recursos/visor/notion-manual-sops',
  ...
  },
  {
    ...
    description: 'Calcula el retorno de inversión de tus campañas publicitarias y proyecta el costo de adquisición de leads de forma sencilla.',
    type: 'Google Sheets',
    badge: 'Gratis',
    path: '/recursos/visor/sheets-calculadora-leads',
  ...
  },
  {
    ...
    description: 'Instrucción avanzada estructurada bajo técnicas de copywriting (AIDA) para redactar correos y landing pages altamente persuasivas.',
    type: 'Prompt Claude/ChatGPT',
    badge: 'Gratis',
    path: '/recursos/visor/prompt-generador-copys',
  ...
  },
  {
    ...
    type: 'Prompt System',
    badge: 'Gratis',
    path: '/pruebas/recursos/visor/prompt-calibracion-soporte',
  ...
  },
  {
    ...
    description: 'Lista de verificación obligatoria antes de encender tus anuncios. Evita errores de píxel, presupuestos y segmentaciones.',
    type: 'PDF / Checklist',
    badge: 'Gratis',
    path: '/recursos/visor/checklist-campana-ads',
  ...
  },
  {
    ...
    type: 'PDF / Checklist',
    badge: 'Gratis',
    path: '/pruebas/recursos/visor/checklist-auditoria-seguridad',
  ...
  },
  {
    ...
    description: 'Código de servidor listo para recibir webhooks de Meta y volcar los contactos y mensajes entrantes a un tablero de Notion.',
    type: 'Código JavaScript',
    badge: 'Premium',
    path: '/recursos/visor/script-whatsapp-notion',
  ...
  },
  {
    ...
    description: 'Código sencillo de automatización para respaldar todas sus hojas de cálculo clave en Google Drive en formato CSV diariamente.',
    type: 'Apps Script',
    badge: 'Gratis',
    path: '/pruebas/recursos/visor/script-sheets-backup',
...
export function Header() {
  ...
  const links = [
    ['Estudio', '/pruebas/estudio'],
    ['Sistemas digitales', '/pruebas/automatizacion'],
    ['Academy', '/pruebas/academy'],
    ['Recursos', '/pruebas/recursos'],
    ['Blog', '/blog'],
  ]

  return (
    <header className="absolute inset-x-0 top-0 z-30 h-20 bg-transparent">
      <div className="mx-auto flex h-full max-w-[96rem] items-center justify-between px-6 sm:px-10 lg:px-14">
        <Link to="/pruebas" className="text-xl font-semibold tracking-[-0.055em] text-[#191918]">
        ...
        <nav className="hidden items-center gap-7 lg:flex xl:gap-10">
          {links.map(([label, href]) => {
            const isActive = pathname === href || 
              (href === '/pruebas/recursos' && pathname.startsWith('/pruebas/recursos')) ||
...
export default function RecursosPruebaPage() {
      ...
      <section className="relative overflow-hidden bg-[#f5f5f4] pt-28 pb-16 text-[#191918] sm:pt-36 sm:pb-24 border-b border-black/10">
        ...
        <div className="relative z-10 mx-auto max-w-[94rem] px-6 text-left sm:px-10 lg:px-14">
          <div className="min-h-[190px] sm:h-[220px]">
            ...
            >
              Recursos y Blog<span className="text-[#ff4b0b]">.</span>
            </motion.h1>
            <motion.p
            ...
            >
              Explora herramientas, plantillas, guías y artículos prácticos sobre IA, sistemas y productividad aplicada.
            </motion.p>
          </div>
          ...
          {!activeCategory ? (
            ...
            <motion.div key="all" initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ duration: 0.3 }}>
                  ...
                  >
                    ...
                    <div className="relative z-10 w-[60%]">
                      <span className="mb-3 inline-flex items-center gap-2 rounded-full px-3.5 py-1.5 text-[11px] font-bold uppercase tracking-widest" style={{ background: 'rgba(124,58,237,0.15)', color: '#5b21b6' }}>
                        <TrendingUp size={12} strokeWidth={3} /> Más Descargada
                      </span>
                  ...
                  >
                    ...
                    <div className="relative z-10 w-[60%]">
                      <span className="mb-3 inline-flex items-center gap-2 rounded-full px-3.5 py-1.5 text-[11px] font-bold uppercase tracking-widest" style={{ background: 'rgba(14,116,144,0.15)', color: '#155e75' }}>
                        <Star size={12} strokeWidth={3} /> Súper Destacada
                      </span>
              ...
              <div className="mb-6 flex items-center justify-between border-b border-black/10 pb-4">
                ...
                <Link to="/pruebas/recursos/prompts" className="flex items-center gap-2 text-sm font-bold text-[#191918]/60 transition-colors hover:text-[#ff4b0b]">
              ...
              <div className="mb-6 flex items-center justify-between border-b border-black/10 pb-4">
                <h2 className="text-2xl font-bold uppercase tracking-tight text-[#191918]" style={displayFont}>Recién agregados</h2>
              </div>
              <div className="mb-16 grid grid-cols-1 gap-5 sm:grid-cols-2 lg:grid-cols-4">
            ...
            <motion.div key="filtered" initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ duration: 0.3 }}>
              <div className="mb-8 flex flex-wrap items-center justify-between gap-4 border-b border-black/10 pb-6">
                ...
                <Link to="/pruebas/recursos" className="inline-flex items-center gap-2 rounded-md border border-black/10 bg-white px-5 py-2.5 text-xs font-bold uppercase tracking-widest text-[#191918] transition-all hover:bg-black/5">
              ...
              {filteredResources.length > 0 ? (
                ...
                <div className="mb-16 rounded-md border border-dashed border-black/20 py-24 text-center">
                  <p className="text-[#191918]/50 font-bold uppercase tracking-widest text-sm">No hay recursos en esta categoría todavía.</p>
                </div>
              )}
            </motion.div>
          )}
          <div className="flex flex-wrap items-center gap-10 rounded-md border border-[#ff4b0b]/20 bg-[#ff4b0b]/5 px-10 py-12">
            <div className="flex-1 min-w-[300px]">
              ...
              <p className="mb-6 text-sm leading-relaxed text-[#191918]/70">
                Aprende a integrar herramientas de automatización, IA y marketing en flujos reales. Menos teoría suelta, más capacidad instalada.
              </p>
              <Link to="/pruebas/academy" className="inline-flex items-center gap-2 rounded-md bg-[#ff4b0b] px-6 py-3 text-xs font-bold uppercase tracking-widest text-white transition-colors hover:bg-[#dc3d00]">
...
function Footer() {
  return (
    <footer className="border-t border-black/10 bg-[#efede8] px-6 py-8 text-[#191918] sm:px-10 lg:px-16">
      <div className="mx-auto flex max-w-[94rem] flex-col items-start justify-between gap-6 md:flex-row md:items-center">
        <Link to="/pruebas" className="text-xl font-semibold tracking-[-0.055em]">
          Qaway <span className="text-[#ff4b0b]">Lab</span>
        </Link>
        <nav className="flex flex-wrap gap-x-7 gap-y-3 text-[11px] font-semibold text-[#191918]/60">
          <Link to="/pruebas/estudio" className="hover:text-black transition-colors">Estudio</Link>
          <Link to="/pruebas/automatizacion" className="hover:text-black transition-colors">Sistemas digitales</Link>
          <Link to="/pruebas/academy" className="hover:text-black transition-colors">Academy</Link>
          <Link to="/pruebas/recursos" className="hover:text-black transition-colors">Recursos</Link>
        </nav>
        <span className="text-[10px] uppercase tracking-[0.16em] text-[#191918]/40 font-semibold">
          Lima · Perú
        </span>
      </div>
    </footer>
