/**
 * taypi-pago-prod — crea un pago en TAYPI Producción y registra el pendiente.
 *
 ...
 *
 * Credenciales: TAYPI_PROD_PUBLIC_KEY, TAYPI_PROD_SECRET_KEY y, para la
...
Deno.serve(async (req) => {
  ...
  try {
    if (!TAYPI_PUBLIC_KEY || !TAYPI_SECRET_KEY) {
      return jsonResponse(
        { success: false, error: "Faltan las credenciales de TAYPI PROD" },
        500,
      );
    }
