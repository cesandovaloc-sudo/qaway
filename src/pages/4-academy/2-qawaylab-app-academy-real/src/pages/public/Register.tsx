...
import { CheckCircle2, Eye, EyeOff, GraduationCap, Loader2, Lock, LogIn, Mail, User } from 'lucide-react'
  ...
  return (
    <div>
      ...
      <div className="text-center mb-8">
        ...
        <h1 className="text-2xl font-bold text-surface-900 tracking-tight">Crear tu cuenta</h1>
        <p className="mt-1 text-sm text-surface-500">
          Únete a Qaway Lab Academy y accede a la formación
        </p>
      </div>
      ...
      <div className="bg-white rounded-3xl border border-surface-200/80 shadow-xl shadow-slate-200/50 p-8 space-y-6">
        ...
        <div className="flex bg-surface-100 p-1 rounded-2xl border border-surface-200">
          <Link
            to={safeRedirect ? `/academy/app/acceder?redirect=${encodeURIComponent(safeRedirect)}` : '/academy/app/acceder'}
        ...
        <div className="relative flex py-0.5 items-center">
          ...
          <span className="flex-shrink mx-3 text-[10px] font-semibold text-surface-400 uppercase tracking-wider">o con datos de registro</span>
          <div className="flex-grow border-t border-surface-200"></div>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div>
            <label htmlFor="fullName" className="block text-xs font-semibold text-surface-700 mb-1.5">
              Nombre completo
            </label>
          ...
          >
            <LogIn className="w-4 h-4" /> {loading ? 'Creando cuenta...' : 'Crear cuenta de estudiante'}
          </button>
        </form>
