        ...
        <div className="projects-shell">
          ...
          <div className="grid grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-4 justify-items-center">
            {[
              ...
              >
                {/* Marco de Teléfono Celular en Gris Claro / Plata Mate (#71717a) */}
                <div className="relative w-full max-w-[270px] aspect-[9/18.5] rounded-[36px] border-[7px] border-[#71717a] bg-[#71717a] p-1.5 shadow-[0_20px_45px_rgba(0,0,0,0.08)] transition-all duration-500 group-hover:-translate-y-2 group-hover:shadow-[0_28px_60px_rgba(0,0,0,0.14)]">
                  {/* Notch / Dynamic Island */}
                  <div className="absolute top-3 left-1/2 -translate-x-1/2 z-20 h-4 w-20 rounded-full bg-[#71717a]" />
                  ...
                  <div className="h-full w-full overflow-hidden rounded-[28px] bg-zinc-100 relative">
                    <img
                      ...
                      className="h-full w-full object-cover object-top"
                    />
                    <div className="absolute top-4 left-3 rounded-full bg-[#71717a]/90 px-2 py-0.5 text-[9px] font-bold uppercase tracking-wider text-white backdrop-blur-xs">
                      {mockup.tag}
                    </div>
                  </div>
                </div>
