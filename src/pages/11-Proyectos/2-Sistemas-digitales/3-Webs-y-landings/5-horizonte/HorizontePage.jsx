...
export default function HorizontePage() {
  ...
  return (
    <main className="min-h-screen bg-[#0D1B17] text-[#F6F4F1] font-sans selection:bg-[#C49A44] selection:text-[#0D1B17]">
      ...
      <header className="fixed top-0 left-0 right-0 z-50 border-b border-white/10 bg-black/40 backdrop-blur-xl">
        <div className="max-w-[1440px] mx-auto px-6 h-16 flex items-center justify-between">
          <div className="font-semibold tracking-tight text-lg">
            QAWAY<span className="text-[10px] ml-1 align-top opacity-60">LAB</span>
          </div>
          <div className="hidden md:block text-[10px] uppercase tracking-[0.2em] text-white/60">
            Sistemas digitales que conectan, organizan y convierten.
          </div>
          <div className="font-mono text-xs uppercase tracking-widest text-[#C49A44]">
            Caso de estudio
          </div>
        </div>
      </header>
      ...
      {/* ========================================================================= */}
      {/* VERSIÓN B — PRESENTACIÓN ESTILO BEHANCE: VENTANA SOBRE FONDO               */}
      {/* Fondo inmobiliario a pantalla completa + columna/ventana central donde    */}
      {/* viven todos los componentes. Da sensación de ventana emergente SIN serlo: */}
      {/* el contenido es HTML real en el DOM (SEO), no un modal.                   */}
      {/* ========================================================================= */}

      <section id="presentacion-horizonte" className="relative overflow-hidden bg-[#0a0a0a]">
        {/* Fondo: imagen inmobiliaria */}
        <img
        ...
        />
        {/* Overlays para que la ventana destaque sobre la foto */}
        <div className="absolute inset-0 bg-black/55" />
        <div className="absolute inset-0 bg-gradient-to-b from-black/60 via-transparent to-black/60" />
        <div className="absolute inset-0" style={{ boxShadow: 'inset 0 0 200px 70px rgba(0,0,0,0.5)' }} />

        <div className="relative z-10 py-20 md:py-28 px-4 sm:px-6">
          <div className="relative mx-auto max-w-[960px]">
            {/* Etiqueta sobre el fondo, fuera de la ventana */}
            <div className="mb-8 flex flex-col items-center gap-2 text-center">
              <span className="font-mono text-[9px] tracking-[0.3em] uppercase text-white/70">Caso de estudio · Qaway Lab</span>
              <span className="font-mono text-[9px] tracking-[0.3em] uppercase text-white/40">Presentación · Versión B</span>
            </div>

            {/* LA VENTANA — columna donde viven los componentes */}
            <div className="relative rounded-2xl bg-[#F6F4F1] text-[#0D1B17] shadow-[0_60px_140px_-30px_rgba(0,0,0,0.85)] ring-1 ring-white/20">
              {/* Barra de título */}
              <div className="rounded-t-2xl overflow-hidden border-b border-[#0D1B17]/10 bg-[#EDEBE6]">
                <div className="flex items-center justify-between px-5 py-3.5">
                  <div className="flex gap-1.5">
                    <span className="w-3 h-3 rounded-full bg-[#C49A44]" />
                    <span className="w-3 h-3 rounded-full bg-[#0D1B17]/15" />
                    <span className="w-3 h-3 rounded-full bg-[#0D1B17]/15" />
                  </div>
                  <div className="font-mono text-[10px] tracking-[0.2em] uppercase text-[#0D1B17]/50 hidden sm:block">
                    Horizonte Inmobiliaria — Caso de estudio
                  </div>
                  <div className="w-12" />
                </div>
              </div>
              ...
              <div className="relative p-6 md:p-12 lg:p-14">
                {/* B-01 — Portada como HERO (mismo diseño que el hero real) */}
                <div className="relative -mx-6 md:-mx-12 lg:-mx-14 -mt-6 md:-mt-12 lg:-mt-14 overflow-hidden bg-[#0a0a0a] text-white">
                  {/* Video de fondo */}
                  <video autoPlay loop muted playsInline className="absolute inset-0 w-full h-full object-cover opacity-60" src="/assets/horizonte/hero-urban-apartment.mp4" />
                  <div className="absolute inset-0 bg-gradient-to-r from-black/80 via-black/40 to-transparent" />
                  <div className="absolute inset-0 bg-gradient-to-t from-[#0D1B17] via-transparent to-transparent" />

                  <div className="relative z-10 px-6 md:px-12 lg:px-14 py-16 md:py-24">
                    <div className="grid grid-cols-1 md:grid-cols-12 gap-12 md:gap-8 items-end">
                      <motion.div {...fade} className="md:col-span-8">
                        ...
                        <h1 className="font-serif text-5xl md:text-6xl lg:text-[5.5rem] leading-[0.9] tracking-tight mb-6">
                          Horizonte<br />Inmobiliaria
                        </h1>
                        <p className="text-base md:text-xl text-white/80 max-w-xl leading-relaxed mb-8">
                        ...
                        <div className="flex flex-col gap-5 text-sm text-white/80">
                          {[
                            ...
                            <div key={k} className="flex gap-3">
                              <div className="mt-0.5 text-[#C49A44]"><Icon size={18} strokeWidth={1.5} /></div>
                              <div>
                                <div className="font-mono text-[9px] tracking-widest text-white/50 mb-0.5 uppercase">{k}</div>
                                <div className="font-medium text-[12px] leading-snug">{v}</div>
                              </div>
                            </div>
                          ))}
                        </div>
                ...
                <div className="mt-12 pt-5 border-t border-[#0D1B17]/10 flex items-center justify-between font-mono text-[10px] uppercase tracking-widest text-[#0D1B17]/50">
                  <span>Vídeo principal — la experiencia en movimiento</span>
                  <span>Fig. 01</span>
                </div>

                {/* B-02 — El proyecto */}
                <div className="mt-16">
                  <SectionLabel n="01" title="EL PROYECTO" color="text-[#0D1B17]/60" />
                  <h2 className="font-serif text-2xl md:text-3xl mt-5 leading-tight max-w-lg">
                  ...
                  <div className="grid sm:grid-cols-2 gap-5 mt-10">
                    {[
                      ...
                      <motion.div {...fade} transition={{ delay: i * 0.08, duration: 0.6 }} key={title} className="bg-white rounded-xl p-6 ring-1 ring-[#0D1B17]/10 shadow-[0_16px_35px_-18px_rgba(13,27,23,0.35)]">
                        <Icon size={20} strokeWidth={1.5} className="text-[#C49A44] mb-5" />
                        <h3 className="font-mono text-[10px] tracking-widest uppercase mb-2.5 text-[#0D1B17]/70">{title}</h3>
                        <p className="text-sm leading-relaxed text-[#0D1B17]/70">{desc}</p>
                      </motion.div>
                    ))}
                  </div>
                  <div className="mt-12 pt-5 border-t border-[#0D1B17]/10 flex items-center justify-between font-mono text-[10px] uppercase tracking-widest text-[#0D1B17]/50">
                    <span>De la necesidad al resultado</span>
                    <span>Fig. 02</span>
                  </div>
                </div>

                {/* B-03 — Experiencia digital */}
                <div className="mt-16">
                  <div className="flex flex-wrap items-end justify-between gap-6">
                    <div>
                      <SectionLabel n="02" title="EXPERIENCIA DIGITAL" color="text-[#0D1B17]/60" />
                      <h2 className="font-serif text-2xl md:text-3xl mt-5 leading-tight">Diseñada para inspirar y convertir.</h2>
                    </div>
                    <div className="flex gap-6">
                      {[
                        ...
                        <div key={label} className="text-center">
                          <Icon size={20} strokeWidth={1.5} className="mx-auto mb-2 text-[#C49A44]" />
                          <div className="text-[9px] font-mono tracking-wider text-[#0D1B17]/50">{label}</div>
                        </div>
                      ))}
                    </div>
                  </div>
                  ...
                  <div className="relative mt-10">
                    <motion.div {...fade} className="relative z-10">
                      <div className="rounded-xl overflow-hidden ring-1 ring-[#0D1B17]/10 shadow-[0_35px_70px_-25px_rgba(13,27,23,0.45)]">
                        <div className="aspect-[16/10] bg-black relative">
                          ...
                          <div className="absolute inset-0 bg-black/40 flex flex-col items-center justify-center text-center p-8">
                            <h3 className="font-serif text-3xl md:text-4xl text-white mb-4">Vive en la mejor<br />zona de la ciudad</h3>
                            <div className="w-12 h-1 bg-[#C49A44]" />
                          </div>
                        </div>
                      </div>
                    </motion.div>
                  ...
                  <div className="mt-12 pt-5 border-t border-[#0D1B17]/10 flex items-center justify-between font-mono text-[10px] uppercase tracking-widest text-[#0D1B17]/50">
                    <span>La experiencia se adapta a cada pantalla</span>
                    <span>Fig. 03</span>
                  </div>
                </div>
              </div>
            ...
            {/* Asset flotante sobre el fondo: vista móvil (peeks fuera de la ventana) */}
            <motion.div {...fade} transition={{ delay: 0.2, duration: 0.6 }} className="absolute -bottom-10 right-2 md:-right-6 z-30 w-[130px] md:w-[170px] rotate-3">
              <div className="bg-white p-2 md:p-2.5 rounded-[1.6rem] ring-1 ring-white/40 shadow-[0_30px_60px_-15px_rgba(0,0,0,0.7)]">
                <img
                  ...
                  className="w-full aspect-[9/19] object-cover rounded-[1.2rem]"
                />
              </div>
            </motion.div>
          </div>
      ...
      {/* Separador de comparación */}
      <div className="py-8 px-6 bg-[#0D1B17] flex items-center justify-center gap-3">
        <span className="font-mono text-[10px] tracking-[0.3em] uppercase text-white/40">Versión actual · A</span>
      </div>
