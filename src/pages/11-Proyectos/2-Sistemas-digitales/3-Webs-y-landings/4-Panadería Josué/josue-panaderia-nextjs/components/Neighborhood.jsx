...
function AnimatedStat({ end, prefix = "", suffix = "" }) {
    ...
    <section className="section sectionSoft">
      <Reveal className="container neighborhood">
        <div className="neighborhoodImage">
          <img src="/josue-images/sections/section-interior-bakery2.webp" alt="Interior de Josué Panadería" style={{ width: "100%", height: "100%", objectFit: "cover" }} />
        </div>
