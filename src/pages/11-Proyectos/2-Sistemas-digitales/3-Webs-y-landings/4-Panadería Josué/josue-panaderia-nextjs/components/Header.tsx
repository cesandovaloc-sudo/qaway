...
const links = [
  ["Inicio", "#inicio"], ["Productos", "#productos"], ["Nosotros", "#nosotros"],
  ["Pedidos", "#pedidos"], ["Ubicación", "#ubicacion"], ["Contacto", "#contacto"]
];
export function Header() {
  ...
  return <header className="siteHeader">
    <div className="container headerInner">
      ...
      <a className="button buttonPrimary headerCta" href={whatsappUrl("Hola, quisiera hacer una consulta.")} target="_blank" rel="noreferrer">Escríbenos</a>
    </div>
  </header>;
}
