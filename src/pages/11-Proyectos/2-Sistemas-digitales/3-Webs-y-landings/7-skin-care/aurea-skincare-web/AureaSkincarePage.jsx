...
const IMG = {
  ...
  hero_products: "/aurea-images/hero_pill_v2.webp",
  ...
  ritual: "/aurea-images/ritual_v2.webp",
  ...
  commitment_1: "/aurea-images/commitment_1.webp",
  commitment_2: "/aurea-images/commitment_2.webp",
  commitment_3: "/aurea-images/commitment_3.webp",
  commitment_4: "/aurea-images/commitment_4.webp",
  why_products: "/aurea-images/why_products_v2.webp",
  product_col_1: "/aurea-images/product_col_1.webp",
  product_col_2: "/aurea-images/product_col_2.webp",
  product_col_3: "/aurea-images/product_col_3.webp",
  product_col_4: "/aurea-images/product_col_4.webp",
  product_col_5: "/aurea-images/product_col_5.webp",
  product_col_6: "/aurea-images/product_col_6.webp",
};
...
export default function AureaSkincarePage() {
  ...
  return (
    <div className="aurea-landing" id="inicio">
        ...
        <section className="section commitment-v2" style={{ display: "none" }}>
          <div className="container">
            ...
            <div className="editorial-mosaic">
              {/* Columna 1: [Foto 1] arriba, [Texto 01] abajo */}
              <Reveal delay={0.04}>
              ...
              {/* Columna 2: [Texto 02] arriba, [Foto 3] abajo */}
              <Reveal delay={0.08}>
                <div className="mosaic-column">
                  <div className="mosaic-text">
                    <div className="mosaic-glyph"><Leaf size={18} strokeWidth={1.4} /></div>
              ...
              {/* Columna 3: [Foto 2] arriba, [Texto 03] abajo */}
              <Reveal delay={0.12}>
                <div className="mosaic-column">
                  <div className="mosaic-photo">
              ...
              {/* Columna 4: [Texto 04] arriba, [Foto 4] abajo */}
              <Reveal delay={0.16}>
                <div className="mosaic-column">
                  <div className="mosaic-text">
      ...
      <StudioFloatingDock projectName="Auréa Skincare" />
    </div>
  );
}
