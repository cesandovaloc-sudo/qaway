    ...
    <section className="relative overflow-hidden pt-28 pb-12 sm:pt-36 sm:pb-16 text-[#20201f] bg-white border-b border-zinc-200/80">
      ...
      <div className="mx-auto max-w-[1240px] px-6 sm:px-10 lg:px-12">
        <div className="max-w-4xl">
          ...
          <div className="mb-4 inline-flex items-center gap-2 font-mono text-[12px] font-bold uppercase tracking-widest text-[#ff4b0b]">
          ...
          >
            ...
            <span className="text-[#ff4b0b]">formación con IA.</span>
          </motion.h1>
          ...
          >
            <a
              ...
              className="group inline-flex min-h-[48px] items-center justify-center gap-2.5 bg-[#ff4b0b] px-7 py-3.5 text-[14.5px] font-bold text-white rounded-[10px] shadow-[0_12px_28px_rgba(255,75,11,0.22)] hover:bg-[#df3900] active:translate-y-px transition-all"
            >
          ...
          >
            <a
              href="#ecosistema"
              className="px-4 py-2 bg-[#ff4b0b] text-white text-xs font-bold rounded-[10px] shadow-xs transition-all"
            >
              Todos
            </a>
            <a
