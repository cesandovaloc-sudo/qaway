            ...
            >
              {submitted ? (
                <div className="qw-form-success">
                  ...
                  <div className="mt-8 flex flex-row items-center gap-3.5 flex-wrap">
                    {waUrl && (
                      <a
                        href={waUrl}
                        target="_blank"
                        rel="noopener noreferrer"
                        className="inline-flex h-12 items-center justify-center gap-2.5 rounded-[10px] bg-[#05a845] px-5 text-[0.92rem] font-medium text-white shadow-sm transition-all hover:bg-[#04963d] whitespace-nowrap"
                      >
                        <svg viewBox="0 0 24 24" width="19" height="19" fill="currentColor" className="shrink-0 text-white">
                    ...
                    <button
                      type="button"
                      onClick={onReset}
                      className="inline-flex h-12 items-center justify-center gap-2.5 rounded-[10px] border border-black/15 bg-white px-5 text-[0.92rem] font-medium text-[#20201f] shadow-sm transition-all hover:bg-black/[0.03] whitespace-nowrap"
                    >
                      <Mail size={18} className="shrink-0 text-[#20201f]" />
                      <span>Enviar otro mensaje</span>
                      <ArrowRight size={16} className="shrink-0 text-[#20201f]" />
                    </button>
                  </div>
                </div>
              ) : (
