...
export default function OptimizadorWebpAppPage() {
  ...
  const handleShare = () => {
    if (navigator.share) {
      navigator.share({
        title: 'Optimizador WebP Online Gratuito | Qaway Lab',
      ...
      <section className="bg-white px-6 pt-12 pb-10 sm:px-10 lg:px-14 border-b border-[#20201f]/10">
        <div className="mx-auto max-w-[1240px] text-center">
          <div className="mb-3.5 inline-flex items-center gap-2 font-mono text-[11px] font-bold uppercase tracking-widest text-[#ff4b0b]">
            <span>/ Recursos · Herramienta Web Gratuita</span>
          </div>
          ...
          >
            Optimizador y Conversor a <span className="text-[#ff4b0b]">WebP.</span>
          </h1>
