...
export function AppSwitcherDropdown({ isOpen, onClose }) {
  ...
  return (
    <div
      ref={dropdownRef}
      className="absolute left-0 top-[calc(100%+8px)] mt-0 w-80 rounded-xl border border-zinc-200 bg-white p-3 shadow-[0_20px_60px_rgba(0,0,0,0.15)] ring-1 ring-black/5 animate-in fade-in slide-in-from-top-2 duration-200 z-[100] text-left"
    >
      {/* Aplicaciones del Ecosistema (primero: son la oferta principal) */}
      ...
      {/* Portales Globales (después de las apps, sin distraer) */}
      <div className="pt-2">
        <p className="px-3 py-1 text-[11px] font-bold uppercase tracking-wider text-zinc-400">
          Portales Globales
        </p>
