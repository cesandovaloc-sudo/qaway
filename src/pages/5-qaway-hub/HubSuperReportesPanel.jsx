...
function getComputedStyleSafe(cls) {
  const map = {
    "seg-premium": "rgb(255, 75, 11)",
    "seg-intermedio": "rgb(255, 122, 69)",
    "seg-basico": "rgb(255, 155, 115)",
    "seg-empresarial": "rgb(212, 212, 216)",
  };
  return map[cls] || "#ccc";
}
