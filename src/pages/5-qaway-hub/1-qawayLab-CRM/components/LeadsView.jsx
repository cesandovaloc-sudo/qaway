        ...
        <div className="overflow-x-auto">
          ...
          <thead>
            <tr className="bg-zinc-50/80 border-b border-zinc-200/60 text-[11px] font-bold text-zinc-500 uppercase tracking-wider select-none">
              ...
              <th className="py-3 px-4">Canal / Origen</th>
              ...
              <tr>
                <td colSpan="6" className="py-12 text-center text-zinc-400">
                  <div className="flex flex-col items-center justify-center gap-2">
                    ...
                    <p className="font-semibold text-zinc-600">No se encontraron leads registrados</p>
                  ...
                  >
                    ...
                    <td className="py-3.5 px-4">
                      <div className="flex items-center gap-3">
                        <div className="w-8 h-8 rounded-full bg-zinc-100 border border-zinc-200 flex items-center justify-center font-bold text-zinc-600 text-xs shrink-0 group-hover:border-[#ff4b0b]/40 group-hover:text-[#ff4b0b] transition-colors">
                          {displayName.charAt(0).toUpperCase()}
                        </div>
                        <div className="min-w-0">
                          <p className="font-bold text-zinc-900 truncate flex items-center gap-1.5">
                            {displayName}
                            {lead.isHumanRequested && (
                              <span className="inline-flex items-center px-1.5 py-0.5 rounded-sm text-[9px] font-bold bg-amber-100 text-amber-800" title="Asesor humano requerido">
                                ⚠️ Asesor
                              </span>
                            )}
                          </p>
                          <p className="text-[11px] text-zinc-400 font-mono truncate">{displayPhone || lead.email || '—'}</p>
                        </div>
                      </div>
                    </td>
                    ...
                    <td className="py-3.5 px-4">
                      <div className="flex flex-col items-start gap-1">
                        ...
                        {referralAd && (
                          <span className="text-[10px] text-purple-600 font-medium truncate max-w-[150px]" title={referralAd}>
                            📢 {referralAd}
                          </span>
                        )}
                      </div>
                    ...
                    <td className="py-3.5 px-4" onClick={(e) => e.stopPropagation()}>
                      <select
                        ...
                        className={`text-[11px] font-bold px-2.5 py-1 rounded-lg border focus:outline-none cursor-pointer transition-all ${statusMeta.bg} ${statusMeta.text} ${statusMeta.border}`}
                      >
                      ...
                      <div className="flex items-center justify-end gap-1.5">
                        {isWhatsApp && displayPhone && (
                          <button
                            ...
                            className="inline-flex items-center gap-1 px-2.5 py-1.5 rounded-lg text-[11px] font-bold bg-[#111111] text-white hover:bg-[#ff4b0b] transition-colors shadow-xs"
