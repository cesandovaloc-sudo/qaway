...
export default function DigitalPresenceCopy() {
  ...
  return (
    <section id="estrategia-digital" className="vl-section vl-digital" style={{ backgroundColor: '#f8f9fc', color: '#191918', minHeight: '100vh', display: 'flex', flexDirection: 'column', justifyContent: 'center', padding: 'clamp(40px, 4vh, 80px) 0' }}>
