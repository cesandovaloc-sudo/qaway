...
export const FORM_MODELS = [
  ...
  {
    id: 'test-preparacion-digital',
    number: '07',
    title: 'Test de Preparación Digital',
    subtitle: 'Diagnóstico de Madurez y Capacidad Comercial',
    category: 'Diagnóstico & Auditoría Digital',
    badge: 'Modelo Estratégico',
    badgeColor: 'bg-orange-50 text-[#ff4b0b] border-orange-200',
    description: 'Evaluación en dos paneles con estética minimalista y gris difuminado. Mide los 4 pilares clave de tu negocio: Claridad de Oferta, Canal Web, Automatizaciones y Capacidad de Escala.',
    route: '/formularios/test-preparacion-digital',
    icon: Sparkles,
    highlights: ['Panel Dual Minimalista', 'Gris Difuminado Estético', 'Score por 4 Pilares', 'Consejos Estratégicos'],
  },
]
