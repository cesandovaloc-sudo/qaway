      ...
      <section className="border-b border-black/6 bg-[#f3f1ee] py-20 lg:py-28">
        <div className="mx-auto grid max-w-[94rem] gap-12 px-6 sm:px-10 lg:grid-cols-[0.95fr_1.05fr] lg:px-14">
          ...
          <motion.div
            ...
            className="relative overflow-hidden bg-[#121212] p-2 sm:p-3 shadow-[0_26px_80px_rgba(0,0,0,0.16)]"
          >
            ...
            <img
              ...
              className="relative z-10 h-full min-h-[28rem] w-full object-cover object-[50%_30%] rounded-[2px]"
              loading="lazy"
              decoding="async"
            />
