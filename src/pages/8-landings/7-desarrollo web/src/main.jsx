...
const webTypes = [
  {
    icon: LayoutTemplate,
    title: "Landing Pages",
    text: "Una página enfocada en un producto, servicio o campaña.",
  },
  {
    icon: Globe2,
    title: "Web Comercial",
    text: "Un sitio completo para presentar tu negocio y recibir consultas.",
  },
  {
    icon: Sparkles,
    title: "Web Personalizada",
    text: "Una solución diseñada para proyectos con necesidades específicas.",
  },
  {
    icon: ShoppingBag,
    title: "E-commerce",
    text: "Una tienda online preparada para mostrar y vender productos.",
  },
];
  ...
  return (
    <main>
      <header className="nav">
        <a className="brand" href="#inicio">Qaway<span>Lab</span></a>
        <nav>
          <a className="active" href="#webs">Estudio</a>
          <a href="#tipos">Sistemas Digitales</a>
          <a href="#proyectos">Qaway Hub</a>
          <a href="#incluye">Recursos</a>
          <a href="#proyectos">Proyectos</a>
          <a href="#contacto">Blog</a>
        </nav>
        <a className="nav-cta" href="#contacto">Cuéntanos tu proyecto <ArrowRight size={17} /></a>
      </header>
      ...
      <footer>
        <div className="footer-brand">
          <a className="brand" href="#inicio">Qaway<span>Lab</span></a>
          <p>Estudio creativo y tecnológico. Creamos sistemas digitales y webs que impulsan negocios.</p>
        </div>
        <div><strong>NAVEGACIÓN</strong><a href="#inicio">Estudio</a><a href="#tipos">Sistemas Digitales</a><a href="#proyectos">Qaway Hub</a></div>
        <div><strong>RECURSOS</strong><a href="#incluye">Blog</a><a href="#incluye">Recursos gratuitos</a><a href="#incluye">Plantillas</a></div>
        <div><strong>LEGAL</strong><a href="#contacto">Términos y condiciones</a><a href="#contacto">Política de privacidad</a></div>
        <div><strong>SÍGUENOS</strong><a href="#contacto">Instagram</a><a href="#contacto">LinkedIn</a><a href="#contacto">WhatsApp</a></div>
      </footer>
    </main>
  );
}
