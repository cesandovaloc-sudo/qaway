  ...
  return (
    <>
      ...
      <section className="grid min-h-[50rem] bg-[#191918] text-white lg:grid-cols-[58%_42%]">
        <div className="relative min-h-[34rem] overflow-hidden"><img src={`${base}galeria-cercana.png`} alt="Retrato profesional cercano" className="absolute inset-0 h-full w-full object-cover grayscale" /><div className="absolute inset-0 bg-gradient-to-r from-transparent via-transparent to-black/40" /></div>
