        ...
        <div className="h-container" style={{ maxWidth: "1330px" }}>
          ...
          <div className="h-three-cards-grid">
            ...
            <div className="h-ai-feature-card" style={{ background: "#ffffff" }}>
              <div className="h-ai-feature-card-media" style={{ padding: "20px 20px 0 20px", background: "linear-gradient(180deg, #edf0f5 0%, #f8f9fc 100%)", height: "365px", display: "flex", alignItems: "flex-end", justifyContent: "center" }}>
