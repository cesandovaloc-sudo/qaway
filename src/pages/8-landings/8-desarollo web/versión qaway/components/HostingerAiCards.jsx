      ...
      <div className="h-container">
        ...
        <div className="h-three-cards-grid">
          ...
          <div className="h-ai-feature-card">
            <div className="h-ai-feature-card-media" style={{ padding: "18px 18px 0 18px", background: "#eef1f6", height: "220px", display: "flex", alignItems: "flex-end", justifyContent: "center" }}>
