    ...
    <section className="h-split-section" style={{ background: "#ffffff" }}>
      <div className="h-container">
        <div className="h-split-grid">
          {/* Visual Izquierda */}
          <div style={{ position: "relative", background: "linear-gradient(135deg, #a78bfa 0%, #673de6 100%)", borderRadius: "12px", padding: "32px", display: "flex", justifyContent: "center", alignItems: "center" }}>
            <div style={{ background: "#ffffff", borderRadius: "12px", padding: "24px", width: "100%", maxWidth: "360px", boxShadow: "0 20px 40px rgba(0,0,0,0.15)" }}>
              ...
              <div style={{ background: "#f8f9fc", border: "1px solid #e4e4e7", borderRadius: "12px", padding: "16px", marginBottom: "14px" }}>
